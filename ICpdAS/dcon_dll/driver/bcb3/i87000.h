...
//	#define CALLBACK NULL
		...
		#else
			#define Exp87K __declspec(dllimport)
		#endif
	#endif
#endif 
...
Exp87K WORD CALLBACK ReadUpDownDirPulse(long LBuf[], int IBuf[],
        char szSend[], char szReceive[]);


Exp87K WORD CALLBACK ReadUpDownDirPulse_All(long LBuf[], int IBuf[],
        char szSend[], char szReceive[]);
...
//dwBuf[8];		// Counter or Frequency Status
  ...
  Exp87K WORD CALLBACK ReadOutputAlarmState_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
  ...
  Exp87K WORD CALLBACK ReadAlarmLimitValue_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
  ...
  Exp87K  WORD CALLBACK ReadEventCounter_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   Exp87K WORD CALLBACK ClearEventCounter_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   Exp87K WORD CALLBACK SetAlarmLimitValue_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   //fValue=fBuf[0];        // Alarm Limit Value
    ...
    Exp87K WORD CALLBACK EnableAlarm_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   //wFlag=(char)dwBuf[6];   // flag: 0=no save, 1=save send/receive string
	...
	Exp87K WORD CALLBACK DisableAlarm_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   Exp87K WORD CALLBACK ClearLatchAlarm_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   Exp87K WORD CALLBACK EnableLinearMapping_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
  ...
  Exp87K WORD CALLBACK DisableLinearMapping_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   Exp87K WORD CALLBACK ReadLinearMappingStatus_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   Exp87K WORD CALLBACK ReadSourceValueOfLM_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
  ...
  Exp87K WORD CALLBACK ReadTargetValueOfLM_87K(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
   ...
   Exp87K WORD CALLBACK DigitalOut_87016(DWORD dwBuf[], float fBuf[],
        char szSend[], char szReceive[]);
